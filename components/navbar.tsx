...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            ...
            className="grid place-items-center h-8 w-8 sm:h-10 sm:w-10 rounded-full transition-all hover:bg-primary/10 md:hidden border border-border/40 hover:border-primary/30 hover:shadow-sm active:scale-95 active:bg-primary/15"
      ...
      <AnimatePresence mode="wait">
        {mobileMenuOpen && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="md:hidden overflow-hidden border-t border-border/50 bg-gradient-to-b from-background to-muted/20 shadow-inner"
          >
            <motion.div
              className="container py-5 flex flex-col space-y-3.5"
              initial="hidden"
              animate="visible"
              variants={{
                hidden: { opacity: 0 },
            ...
            >
                ...
                >
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg
                      ...
                      transition-all duration-200 text-sm group active:scale-[0.98] active:bg-primary/8`}
                    onClick={() => {
                  ...
                  >
                    ...
                    {activeLink === link.href && (
                      <motion.div
                        ...
                        className="ml-auto h-1.5 w-1.5 rounded-full bg-primary shadow-[0_0_8px_rgba(var(--primary-rgb),0.5)]"
                        initial={{ scale: 0.8 }}
                        animate={{ scale: 1 }}
                      />
                    )}
              ...
              >
                <div className="h-px w-full bg-gradient-to-r from-border/5 via-border/40 to-border/5 my-3 opacity-70"></div>
              </motion.div>
              <motion.div
                variants={{
                  hidden: { opacity: 0, y: 20 },
              ...
              >
                <Button
                  ...
                  size="sm"
                  asChild
                  className="mt-2 w-full justify-start text-xs sm:text-sm h-10 rounded-lg border-primary/20 hover:border-primary/60 hover:shadow-sm hover:bg-primary/5 transition-all duration-200 active:scale-[0.98]"
                >
                  <Link
                    href="https://github.com/NotHarshhaa/home-of-best-devops-resources"
                    target="_blank"
      ...
      {/* No overlay needed for expand style */}
    </header>
  );
};
